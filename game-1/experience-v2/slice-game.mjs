import {createEngine, possessionId} from '../src/engine.mjs';
import {NORMAL, SHOTS, REBOUNDS, DEFENCE, DEF_SHOTS, RECOVERY, BALL_HAND, SPINE, fmt, shotText, reboundText, freeThrowText} from '../src/content.mjs';
...
export function createGame({seed=1, rolls=[], fixture=null}={}) {
  ...
  function enter(mode){
    ...
    if(mode==='v2_defence'||mode==='v2_three'){
